...
use diabolo::bound::GeometricBound;
use diabolo::interval::Interval;
use diabolo::numbers::{Rational, F64};
use diabolo::parser;
use diabolo::ppl::{Program, Var};
use diabolo::semantics::geometric::GeometricBoundSemantics;
use diabolo::semantics::support::VarSupport;
use diabolo::semantics::Transformer;
use diabolo::solvers::adam::AdamBarrier;
use diabolo::solvers::ipopt::Ipopt;
use rustc_hash::FxHashMap;

use clap::{Parser, ValueEnum};
use diabolo::solvers::linear::{optimize_linear_parts, LinearProgrammingOptimizer};
use diabolo::solvers::problem::ConstraintProblem;
use diabolo::solvers::z3::Z3Solver;
use diabolo::solvers::{Optimizer as _, Solver as _, SolverError};
use diabolo::sym_expr::SymExpr;
use ndarray::Axis;
